...
class _ChangePasswordPageState extends State<ChangePasswordPage> {
  ...
  bool isFilled() =>
      textEditingController[0].text.isNotEmpty &&
      textEditingController[1].text.isNotEmpty &&
      textEditingController[2].text.isNotEmpty;

  bool isPassword() => textEditingController[0].text == Me.password;

  bool isSame() =>
      textEditingController[1].text == textEditingController[2].text;
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            buildPadding(10),
            buildTextField(
                textEditingController[2], "Masukan Lagi Password Baru"),
            buildPadding(20),
            Center(
              child: ElevatedButton(
                onPressed: () {
                  if (isFilled() && isPassword() && isSame()) {
                    ...
                    Toast.show("There's Something Wrong", 
                        duration: Toast.lengthShort, gravity: Toast.bottom);
                    return;
                  }
                },
  ...
  Widget buildTextField(
          TextEditingController textEditingController, String name) =>
      Container(
        width: 250,
        height: 45,
        child: TextFormField(
